...
function addEngineer(eng){
    ...
    <a href="#" class="list-group-item list-group-item-action flex-row align-items-center ">
      ...
      <div class="d-flex w-100 justify-content-between">
        <button type="button" class="btn btn-lg btn-info ml-5 mr-2">Office # ${eng.gitHub}</button>
        <!-- <button class="mb-1 ">ID #</button> -->
      </div>
    </a>
  </div>
...
function addIntern (intern) {
    ...
    <a href="#" class="list-group-item list-group-item-action flex-row align-items-center ">
      ...
      <div class="d-flex w-100 justify-content-between">
        <button type="button" class="btn btn-lg btn-info ml-5 mr-2">Office # ${intern.school}</button>
        <!-- <button class="mb-1 ">ID #</button> -->
      </div>
    </a>
  </div>
